const description = {
    ...
    //Сделать валидаторы формы входа по ответу БД!!!
    //Если с текущими проектами и задачами сохранять время, а после удалить задачи или проекты, все собьется. Возможно стоит писать предупреждающее сообщение
    //Вылазит alert, что имя проекта не м.б. пустым во вкладке Проекты, хотя оно не пустое!
    //Сделать отображение description в Time
    //Добавить всплывающие оповещения о разных действиях
    //Добавить в Time данные об исполнителе и ключ (или удалить эти поля), то же с календарем, день/неделя и др
}
